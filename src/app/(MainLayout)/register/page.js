...
const Register = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        // You can add further logic here, like calling an API
        const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/api/users`, formData)
